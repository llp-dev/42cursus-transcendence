...
return (
    <div className="bg-white/80 backdrop-blur border border-gray-200 rounded-2xl p-4 mb-4 shadow-sm">
          ...
          <div className="flex items-center justify-between mt-2 border-t border-gray-100 pt-3">
            ...
            <div className="flex items-center gap-3">
              ...
              <button
                ...
                className="px-4 py-2 bg-indigo-100 hover:bg-indigo-200 text-indigo-400 font-medium rounded-full transition disabled:opacity-50 text-sm"
              >
